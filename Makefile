...
AR := ar
SIZE := size
CFLAG := -mcpu=cortex-m4 -mthumb -mfpu=vfpv4 -mfloat-abi=hard -Idriver/st/ll/inc -Idriver/st/dev/inc -Idriver/cmsis/core -Ilib/oled/inc -Iuser/inc -Ilib/oled/inc -g -save-temps=obj -Wl,--gc-sections -DUSE_FULL_LL_DRIVER -Os -ffunction-sections -fdata-sections -specs=nano.specs 
BUILD_DIR := build/
BINARY_DIR := bin/
