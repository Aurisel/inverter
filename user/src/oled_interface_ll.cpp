...
oled_interface_spi_dma_ll::oled_interface_spi_dma_ll(const spi_config &spi,const dma_config &dma, GPIO_TypeDef *dc_group, uint32_t dc_pin)
{
...
void gpio_clk_enable(uint32_t gpio_group)
{
    switch(gpio_group)
    {
        case GPIOA_BASE: LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOA); break;
        case GPIOB_BASE: LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOB); break;
        case GPIOC_BASE: LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOC); break;
        case GPIOD_BASE: LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOD); break;
        case GPIOE_BASE: LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOE); break;
        case GPIOF_BASE: LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOF); break;
        case GPIOG_BASE: LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOG); break;
    }
